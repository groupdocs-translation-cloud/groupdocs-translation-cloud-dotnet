    ...
    public class TranslationApiTests : IDisposable
    {
        ...
        public TranslationApiTests(ITestOutputHelper outputHelper)
        {
            ...
            var conf = new Configuration()
            {
                ...
                OAuthClientId = Environment.GetEnvironmentVariable("GDT_TestClientId"),
                OAuthClientSecret = Environment.GetEnvironmentVariable("GDT_TestClientSecret"),
                OAuthTokenUrl = Environment.GetEnvironmentVariable("GDT_TestTokenUrl"),
