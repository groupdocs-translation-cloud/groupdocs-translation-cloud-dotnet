...
namespace GroupDocs.Translation.Cloud.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("GroupDocs.Translation SDK for C#: 23.12.0");
        ...
        public Configuration(
            ...
            string basePath = "https://api.groupdocs.cloud/v2.0/translation") : this()
        {
        ...
        {
            string report = "C# SDK (GroupDocs.Translation.Cloud.Sdk) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 23.12.0\n";
