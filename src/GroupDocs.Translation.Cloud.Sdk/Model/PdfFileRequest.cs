...
namespace GroupDocs.Translation.Cloud.Sdk.Model
{
    ...
    public partial class PdfFileRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="pages">List of pages to translate (1-based index). If not present, translate all pages.</param>
        public PdfFileRequest(string sourceLanguage = @"en", List<string> targetLanguages = default(List<string>), string originalFileName = default(string), string url = default(string), string origin = default(string), SavingModeEnum? savingMode = default(SavingModeEnum?), string outputFormat = default(string), bool preserveFormatting = true, List<int> pages = default(List<int>))
        {
        ...
        /// </summary>
        /// <value>List of pages to translate (1-based index). If not present, translate all pages</value>
