...
namespace GroupDocs.Translation.Cloud.Sdk.Model
{
    ...
    public partial class SrtFileRequest : IEquatable<SrtFileRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public SrtFileRequest(string sourceLanguage = @"en", List<string> targetLanguages = default(List<string>), byte[] file = default(byte[]), string originalFileName = default(string), string url = default(string), string origin = default(string), SavingModeEnum? savingMode = default(SavingModeEnum?))
        {
        ...
        {
            return this.Equals(input as SrtFileRequest);
        }

        /// <summary>
        /// Returns true if SrtFileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SrtFileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SrtFileRequest input)
        {
            if (input == null)
            {
                return false;
