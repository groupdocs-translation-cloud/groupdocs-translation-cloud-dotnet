...
namespace GroupDocs.Translation.Api.Model
{
    ...
    public partial class CloudFileResponse : IEquatable<CloudFileResponse>, IValidatableObject
    {
        ...
        public CloudFileResponse(StatusEnum? status = default(StatusEnum?), string message = default(string), Dictionary<string, string> urls = default(Dictionary<string, string>), Dictionary<string, float?> scores = default(Dictionary<string, float?>))
        {
            this.Status = status;
