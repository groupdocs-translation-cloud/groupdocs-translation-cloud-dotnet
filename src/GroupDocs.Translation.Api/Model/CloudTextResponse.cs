...
namespace GroupDocs.Translation.Api.Model
{
    ...
    {
        /// <summary>
        /// \&quot;ok\&quot; if translation was successful, \&quot;error\&quot; if error occured
        /// </summary>
        /// <value>\&quot;ok\&quot; if translation was successful, \&quot;error\&quot; if error occured</value>
        ...
        /// </summary>
        /// <param name="status">\&quot;ok\&quot; if translation was successful, \&quot;error\&quot; if error occured.</param>
        /// <param name="message">If file was translated correctly or text of error.</param>
        /// <param name="translations">Translated texts.</param>
        public CloudTextResponse(StatusEnum? status = default(StatusEnum?), string message = default(string), Dictionary<string, List<string>> translations = default(Dictionary<string, List<string>>))
        {
            this.Status = status;
