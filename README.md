...
For convenience of our .NET customers, we introduce a simple SDK that assists to add translation of Microsoft Word documents, Microsoft Excel workbooks, Microsoft PowerPoint presentations, PDF documents, Markdown files, and plain text to your app with merely a few lines of code.
